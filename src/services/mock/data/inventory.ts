  ...
  seedItem(
    {
      id: "inv-013",
      sku: "RAW-BRASS-1IN",
      name: "Brass 1 Inch Raw Material",
      description: "1-inch brass rod / bar stock for nut manufacturing. Purchase cost recorded once.",
      category: "Raw Materials",
      unit: "kg",
      quantityOnHand: 100,
      quantityReserved: 0,
      ...
      reorderQuantity: 100,
      unitCost: 1000,
      location: "Warehouse B - Rack Brass",
      supplier: "Lanka Metals",
      stockStatus: "in_stock",
      status: "active",
      lastRestockedAt: "2025-08-01T09:00:00Z",
