      ...
      <section className="rounded-md border border-border bg-card p-3">
        ...
        <div className="mt-2 flex items-start justify-between gap-2">
          <div className="min-w-0">
            <p className="truncate text-[12px] font-semibold tabular-nums text-foreground" title={values.sku || "SKU"}>
              {values.sku || "SKU"}
            </p>
            <p className="truncate text-sm font-semibold text-foreground" title={values.name || "New inventory item"}>
