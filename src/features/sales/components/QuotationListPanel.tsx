...
const STATUS_TABS: { value: QuotationStatusValue | ""; label: string }[] = [
  { value: "", label: "All" },
  { value: "draft", label: "Draft" },
  { value: "ready_to_send", label: "Submitted" },
...
export type QuotationListPanelProps = {
  items: Quotation[];
  totalCount: number;
  statusCounts?: Partial<Record<QuotationStatusValue | "", number>>;
  selectedId: string | null;
  onSelect: (id: string) => void;
  statusFilter: QuotationStatusValue | "";
  onStatusFilterChange: (status: QuotationStatusValue | "") => void;
  page: number;
  pageSize: number;
