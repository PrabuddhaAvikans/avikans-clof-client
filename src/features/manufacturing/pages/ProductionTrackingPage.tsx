      ...
      >
        {snapshot && (
          <div className="grid min-h-0 flex-1 grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div className="col-span-1 max-h-[480px] overflow-auto border border-border bg-card p-2 md:col-span-2 lg:col-span-1 xl:col-span-1 xl:row-span-2 xl:max-h-[min(720px,calc(100svh-220px))]">
